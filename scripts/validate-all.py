...
def main():
    ...
    run_command(results, "profile index staleness validation", [python, "scripts/generate-profile-index.py", "--check"])
    ...
    run_command(results, "agent registry staleness validation", [python, "scripts/generate-agent-registry.py", "--check"])
    run_command(results, "workflow registry staleness validation", [python, "scripts/generate-workflow-registry.py", "--check"])
    run_command(results, "knowledge health staleness validation", [python, "scripts/generate-knowledge-health.py", "--check"])
    run_command(results, "work activity staleness validation", [python, "scripts/generate-work-activity.py", "--check"])
    run_command(results, "orchestration structural validation", [python, "scripts/orchestration-validate.py"])
